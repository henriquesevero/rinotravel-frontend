 ...
 * bring (tickets, meals and things of the itinerary, flights, stays). One place builds it,
...
export function useTripMoney(trip: Trip) {
  ...
  const queries = [expenses, days, items, restaurants, tickets, flights, hotels, payments];
