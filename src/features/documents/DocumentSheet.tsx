...
import { Banner, Button, FormSelectField, FormTextField, Text, useConfirm } from '@/shared/ui';
  ...
  return (
    ...
    >
      {document ? null : (
        <View style={{ gap: space.sm }}>
          <Button
            ...
            fullWidth
          />
          <Text variant="footnote" tone={fileError ? 'danger' : 'secondary'}>
            {fileError ??
              (file && size
      ...
      <FormSelectField
        ...
        options={VISIBILITIES.map((value) => ({ value, label: t(`enums.visibility.${value}`) }))}
